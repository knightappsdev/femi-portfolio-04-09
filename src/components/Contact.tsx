  ...
  const contactInfo = [
    {
      ...
      link: `mailto:${CONFIG.RECIPIENT_EMAIL}`
    },
    {
      icon: 'bi-phone',
      title: 'Phone',
      value: CONFIG.WHATSAPP_NUMBER,
      link: `tel:${CONFIG.WHATSAPP_NUMBER}`
    },
    {
      icon: 'bi-whatsapp',
      title: 'WhatsApp',
      value: CONFIG.WHATSAPP_NUMBER,
      link: `https://wa.me/${CONFIG.WHATSAPP_NUMBER.replace('+', '')}?text=Hello! I found your portfolio and would like to discuss a project with you.`
    },
    {
      icon: 'bi-geo-alt',
      title: 'Location',
    ...
    <section id="contact" className="py-20 bg-dark-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {[
                  { icon: 'bi-linkedin', url: CONFIG.SOCIAL_LINKS.LINKEDIN, color: 'hover:text-blue-400' },
                  { icon: 'bi-github', url: CONFIG.SOCIAL_LINKS.GITHUB, color: 'hover:text-gray-300' },
                  { icon: 'bi-twitter', url: CONFIG.SOCIAL_LINKS.TWITTER, color: 'hover:text-blue-400' },
                  { icon: 'bi-instagram', url: CONFIG.SOCIAL_LINKS.INSTAGRAM, color: 'hover:text-pink-400' },
                ].map((social, index) => (
                  <a
                    key={index}
                    href={social.url}
          ...
          {/* Contact Form - Routes to connect@ofemo.uk */}
          <div className="bg-dark-800 rounded-2xl p-8 border border-dark-700">
            <h3 className="text-2xl font-bold text-white mb-6">
              Send a <span className="text-lime-400">Message</span>
            </h3>

            <div className="mb-4 p-3 bg-lime-500/10 border border-lime-500/30 rounded-lg">
              <div className="flex items-center text-lime-400 text-sm">
                <i className="bi bi-info-circle mr-2"></i>
                <span>All messages are sent directly to {CONFIG.RECIPIENT_EMAIL}</span>
              </div>
            </div>
            ...
            {showSuccess && (
              <div className="mb-6 p-4 bg-lime-500/20 border border-lime-500/50 rounded-lg">
                <div className="flex items-center text-lime-400">
                  ...
                  <span>Message sent successfully to {CONFIG.RECIPIENT_EMAIL}! I'll get back to you soon.</span>
                </div>
              </div>
            )}
              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    Sending to {CONFIG.RECIPIENT_EMAIL}...
                  </>
                ) : (
                  <>
                    <i className="bi bi-send mr-2"></i>
                    Send Message to {CONFIG.RECIPIENT_EMAIL}
                  </>
                )}
              </button>
            </form>
            ...
            <div className="mt-6 pt-6 border-t border-dark-700">
              ...
              <div className="flex justify-center space-x-4">
                <a
                  href={`mailto:${CONFIG.RECIPIENT_EMAIL}`}
                ...
                <a
                  href={`https://wa.me/${CONFIG.WHATSAPP_NUMBER.replace('+', '')}?text=Hello! I found your portfolio and would like to discuss a project with you.`}
                  target="_blank"
                  rel="noopener noreferrer"
